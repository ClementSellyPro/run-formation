...
const inscriptions_controller_1 = require("./inscriptions.controller");
...
exports.InscriptionsModule = InscriptionsModule = __decorate([
    (0, common_1.Module)({
        ...
        controllers: [inscriptions_controller_1.InscriptionsController],
        providers: [inscriptions_service_1.InscriptionsService],
    })
], InscriptionsModule);
